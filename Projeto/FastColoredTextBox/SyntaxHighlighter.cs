...
namespace FastColoredTextBoxNS
{
	public class SyntaxHighlighter : IDisposable
	{
		...
		protected void InitCShaprRegex()
		{
			...
			CSharpCommentRegex1 = new Regex(@"//.*$", RegexOptions.Singleline | RegexCompiledOption);
			CSharpCommentRegex2 = new Regex(@"(/\*.*?\*/)|(/\*.*)", RegexOptions.Multiline | RegexCompiledOption);
			CSharpCommentRegex3 = new Regex(@"(/\*.*?\*/)|(.*\*/)",
											RegexOptions.Multiline | RegexOptions.RightToLeft | RegexCompiledOption);
...
";
		...
		protected void InitSQLRegex()
		{
			...
			SQLCommentRegex1 = new Regex(@"--.*$", RegexOptions.Singleline | RegexCompiledOption);
