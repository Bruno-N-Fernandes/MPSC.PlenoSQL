...
namespace Tester
{
	public partial class GifImageDrawingSample : Form
	{
		...
		public GifImageDrawingSample()
		{
			...
			style.ImagesByText.Add(@":bb", Resources.bye);
			style.ImagesByText.Add(@":D", Resources.lol);
			style.ImagesByText.Add(@"8)", Resources.rolleyes);
			style.ImagesByText.Add(@":@", Resources.unsure);
			style.ImagesByText.Add(@":)", Resources.smile_16x16);
			style.ImagesByText.Add(@":(", Resources.sad_16x16);
