...
namespace MP.PlenoBDNE.AppWin.Dados
{
	public class BancoDeDadosSQLite : BancoDeDados<SQLiteConnection>
	{
		...
		protected override String AllViewsSQL(Boolean comDetalhes) { return @"Select T.Name As Nome, '' As Detalhes From sqlite_master T Where (T.Type = 'view') And (T.Name Like '{0}%')"; }
		protected override String AllColumnsSQL(Boolean comDetalhes) { return @"PRAGMA table_info({0})"; }
